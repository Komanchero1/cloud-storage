...
6.  пакет "service" содержит 2 класса:
    ...
    информации, предупреждений и ошибок в процессе работы сервиса.
                ...
                Метод помечен аннотацией "@Transactional" - при возникновении ошибки во время работы метода все изменения 
                этой транзакции будут отменены и данные пользователя откатятся на момент начала выполнения операции данным 
                методом.
                ...
                проблема при чтении выбрасывается сообщение об ошибке. 
