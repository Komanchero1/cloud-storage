...
import org.example.cloudstorage.exсeption.InvalidCredentialsException;
import org.example.cloudstorage.exсeption.UnauthorizedAccessException;
    ...
    public void logout(String authToken) {
        ...
        User user = userRepository.findByAuthToken(authToken)
                .orElseThrow(() -> {
                    ...
                    return new UnauthorizedAccessException("Неавторизованный доступ");
                });
