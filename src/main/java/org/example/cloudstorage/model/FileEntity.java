...
public class FileEntity {
    ...
    // Указывает, что у файла может быть связь с одним пользователем, используется EAGER для загрузки связанных данных
    @ManyToOne(fetch = FetchType.EAGER)
    //имя колонки в базе данных, которая будет хранить идентификатор пользователя
    // и что она не может быть пустой, используется EAGER для загрузки связанных данных
